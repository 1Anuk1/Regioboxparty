// select_estados.js - Versión actualizada
$(document).ready(function(){
    ...
    function actualizarMunicipios(idEstadoSelect, idCiudadSelect, ciudadActual = null) {
        ...
        let html = "<option value='' disabled selected>Selecciona el municipio/ciudad</option>";
    ...
    // Inicializar modal Editar cuando se abra (actualizado para nuestro modal)
